...
declare global {
  interface Object {
    ...
    /**
      ...
      *
      * @param {Object} this The object to iterate over.
      * @param {Function|Object|string} [iteratee=_.identity]  The function invoked per iteration.
      * @param {Object} [thisArg] The `this` binding of `iteratee`.
      * @return {Object} Returns the new mapped object.
      */
      mapValues<T, TResult>(this: Dictionary<T>, callback: ObjectIterator<T, TResult>): Dictionary<TResult>
      mapValues<T>(this: Dictionary<T>, where: Dictionary<T>): Dictionary<boolean>
      mapValues<T, TMapped>(this: T, pluck: string): TMapped
      mapValues<T>(this: T, callback: ObjectIterator<any, any>): T
  }
}
